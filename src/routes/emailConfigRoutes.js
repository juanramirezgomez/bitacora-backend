...
import { enviarCorreoPrueba, obtenerEstadoCorreo, obtenerTemplateCorreoPrueba } from "../controllers/emailConfigController.js";
...
router.get("/test/email-template", requireRole("ADMIN"), obtenerTemplateCorreoPrueba);
