...
const obtenerReporteData = async ({ tipo = "semanal", fecha = null }) => {
  ...
  const [
    ...
    AlertaCamioneta.countDocuments({ estado: "ABIERTA", ...fechaFiltro("fechaCreacion", inicio, fin) }),
    ...
    AlertaCamioneta.countDocuments({ prioridad: "CRITICA", estado: "ABIERTA" }),
    ...
    AlertaCamioneta.countDocuments({ estado: "ABIERTA", ...fechaFiltro("fechaCreacion", inicioAnterior, finAnterior) }),
